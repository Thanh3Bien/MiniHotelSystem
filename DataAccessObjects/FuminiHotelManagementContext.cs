...
public partial class FuminiHotelManagementContext : DbContext
{
    ...
    //        => optionsBuilder.UseSqlServer("server =(local); database = FUMiniHotelManagement;uid=sa;pwd=1;Trusted_Connection=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.HasIndex(e => e.EmailAddress, "UQ__Customer__49A14740C71C7184").IsUnique();

            entity.HasIndex(e => e.EmailAddress, "UQ__Customer__49A14740E06B9159").IsUnique();
